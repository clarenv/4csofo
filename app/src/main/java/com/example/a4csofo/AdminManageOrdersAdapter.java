...
public class AdminManageOrdersAdapter extends RecyclerView.Adapter<AdminManageOrdersAdapter.OrderViewHolder> {
    ...
    private Map<String, String> customerNameMap = new HashMap<>(); // customerUid -> customerName
    private OnOrderClickListener orderClickListener; // ADD THIS LINE
    ...
    // ===== CUSTOMER NAME LOADING (FROM AdminUsersFragment PATTERN) =====
    ...
    private String getCustomerName(OrderModel order) {
        ...
        // 1. Try to get from customerUid mapping (MAIN SOURCE)
        ...
        // 2. Try to get from order directly (BACKUP)
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        // ===== CUSTOMER NAME (FROM FIREBASE USERS) =====
        ...
        // ===== ORDER CLICK LISTENER (ADD THIS SECTION) =====
